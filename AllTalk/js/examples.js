		 ...
		 div1_3.attr("id","comment_reply");
		  ...
		  var div1_3_1_1 = $('<div></div>').addClass("isay_text_area area_display").appendTo(div1_3_1);
		   ...
		   var div1_3_1_1_2 = $('<div></div>').addClass("isay_text_operate").appendTo(div1_3_1_1);
		    ...
		    div1_3_2.html("收起");
		    var div1_3_3 = $('<div></div>').addClass("page_change").appendTo(div1_3);
		    var div1_3_3_1 = $('<a></a>').attr("href","javascript:void(0)").addClass("reply_pre").appendTo(div1_3_3);
		    div1_3_3_1.html("←"+" ");
		    var div1_3_3_2 = $('<a></a>').attr("href","javascript:void(0)").addClass("reply_next").appendTo(div1_3_3);
		    div1_3_3_2.html(" "+"→");
	}
