...
(function($, window, document, undefined) {
	...
	methods = {
		...
		add: function(o, $this) {
			...
			if (o.closeHide != false) {
				$obj.stop().append('<a id="HCloseBtn" title="关闭" style="width:40px;height:40px;line-height:18px;display:inline-block;cursor:pointer;background-color:' + closeBg + ';color:#666;font-size:3em;text-align:center;position:absolute;top:0px;right:0px;"><span style="width:40px;height:40px;display:inline-block;">×</span></a>').css({
					"position": "fixed",
	...
	$.extend({
		...
		tooltip: function(t1, t2, t3) {
			...
			var tip = '<div class="HTooltip shake animated" style="width:280px;padding:10px;text-align:center;background-color:#D84C31;color:#fff;position:fixed;top:50%;left:50%;z-index:100001;margin-top:-29px;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">' + t1 + "</div>";
			if (t3) {
				tip = '<div class="HTooltip fadeIn animated" style="width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#fff;position:fixed;top:50%;left:50%;z-index:100001;margin-top:-29px;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">' + t1 + "</div>"
			}
